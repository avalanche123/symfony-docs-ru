...
Symfony2 предлагает три хелпера для работы с ними: ``assets``,
...
Основная цель тега ``asset`` сделать приложение более переносимым. Благодаря ему,
можно переместить корневую папку приложения куда угодно внутри вашей корневой
web директории без изменения шаблона.
