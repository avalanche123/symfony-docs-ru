...
.. tip::
    ...
    и файла ``src/autoload.php``. Для дополнительной информации прочтите
    :doc:`раздел </guides/tools/autoloader>`, посвящённый этому.
...
Над HttpFoundation располагается компонент :namespace:`Symfony\\Component\\HttpKernel`.
...
Он поставляется с рациональной первоначальной конфигурацией и конвенциями для
лучшего обучения.
